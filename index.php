...
<div class="container py-5">
    ...
    <div class="row text-center text-white mb-5">
        <div class="col-lg-8 mx-auto">
            <h1 class="display-4">Everyday PGH</h1>
            <p class="lead mb-0">Nhật ký hằng ngày của Gia Huy. </p>
            <p class="lead">Telegram:<a href="https://t.me/pham_gia_huy" class="text-white">
                <u>@pham_gia_huy</u></a></p>
            </div>
        </div>
        <!-- End -->
